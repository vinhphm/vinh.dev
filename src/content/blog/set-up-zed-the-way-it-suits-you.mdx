...
import zedInlineCompletion from '@/assets/images/2024/zed-inline-completion.gif';
...
<figure>
    <img src={zedInlineCompletion.src} alt="Zed's in line completion" class="rounded-lg shadow-lg" />
</figure>
