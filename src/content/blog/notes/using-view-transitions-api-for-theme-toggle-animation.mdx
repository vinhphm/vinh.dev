...
<figure class="flex flex-col items-center justify-center">
  <video autoplay loop muted playsinline class="rounded-xl w-2/3 md:w-1/2">
    <source src={themeTransitionAnimation} type="video/mp4" />
    Your browser does not support the video tag.
  </video>
</figure>

This animation takes inspiration from [**@hooray**'s snippets](https://github.com/vuejs/vitepress/pull/2347) with some minor tweaks to avoid comflicting with Astro's **View Transitions** feature. You can find my implementation at [ThemeToggle.vue](https://github.com/vinhphm/vinh.dev/blob/main/src/components/ThemeToggle.vue), with some additional CSS rules as shown below:
