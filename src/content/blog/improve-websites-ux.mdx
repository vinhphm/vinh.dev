...
import menuToggle from '@/assets/images/2022/menu-toggle.gif';
import themeToggle from '@/assets/images/2022/theme-toggle.gif';
...
<figure class="pt-5 flex flex-col items-center">
  <img src="{menuToggle.src}" alt="Menu toggle" class="shadow rounded-lg" />
...
<figure class="pt-5 flex flex-col items-center">
  <img src="{themeToggle.src}" alt="Theme toggle" class="shadow rounded-lg" />
  <figcaption class="text-center">
    Theme toggle
  </figcaption>
</figure>
