---
title: Build internal tools with Refine
...
import refineDiagram from '@/assets/images/2023/refine-diagram.png'
import refineQuickStart from '@/assets/images/2023/refine-quick-start.webp'
...
<figure class="md:pt-5 lg:pt-12">
  <div class="lg:scale-120 md:scale-110">
    <Image src={refineDiagram} alt="Refine diagram" class="rounded-lg" />
  </div>
  <figcaption class="important-mt8 text-center">Refine</figcaption>
</figure>
...
<figure class="md:pt-5 lg:pt-8">
  <div class="lg:scale-120 md:scale-110">
    <img src={refineQuickStart.src} alt="Refine quick start" class="rounded-lg shadow-lg" />
  </div>
  <figcaption class="md:important-mt8 lg:important-mt16 text-center">Refine step-by-step</figcaption>
</figure>
