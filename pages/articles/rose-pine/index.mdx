...
import rosePineHome from './rose-pine-homepage.png'
import rosePineCode from './rose-pine-vscode.png'
...
export const meta = {
  ...
  description:
  'If you are just like me, a little bit picky and sometimes can\'t choose between dark and light mode, then maybe Rosé Pine might just be the one.',
}
...
<center><Image src={rosePineHome} alt="Rosé Pine" /></center>
...
<center><Image src={rosePineCode} alt="Rosé Pine Moon on VS Code" /></center>