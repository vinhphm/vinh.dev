...
date: '2022-04-03'
tags: ['micro-interactions', 'ux', 'website', 'app', 'design', 'animations', 'vinh.dev']
draft: false
summary: One of the few things I studied from Google UX Design course is how a good UX design should be fun to use.
...
This one I use React Spring to animate SVG icons based on the instruction from [jfelix.info](https://jfelix.info/blog/using-react-spring-to-animate-svg-icons-dark-mode-toggle) with another small tweaks from me to match with the current setup from my site.
