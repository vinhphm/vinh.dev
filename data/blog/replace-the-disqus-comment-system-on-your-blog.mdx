---
title: Replace the Disqus comment system on your blog
date: '2022-03-25'
...
- **Performance issues:** Disqus is know to degrade page load time. This is mostly due to the syncing of comments back and forth with the server, and calling third party scripts when loading ads.
...
Let's break down the varaibles:
